...
$rosesDescriptionArray = [
  ...
  "AMADEUS" => 'En mycket vacker, riktigt röd klätterros. De mörkröda knopparna slår ut i blodröda sammetslika blommor med synliga gula ståndare i klasar om 5-7 blommor. Blomman går nästan aldrig över i den mer lila-karminröda nyansen utan behåller sin röda färg fint. ',
  "BELLE AMOUR" => 'Albarosorna härstämmer från medeltiden och från östra medelhavsområdet. Rosorna blommar i en begränsade färgnyanser av rosa och vit men de har en delikat skönhet och kompleteras av det grå-gröna bladverket. Albarosorna är bland de friskaste och härdigaste rosorna.',
  "BONITA RENAISSANCE" => 'En Renaissanceros med underbar doft. Plantera gärna i grupper om 3-5 rosor.',
  "CAMELOT" => 'En kraftigväxande klätterros som även kan användas som stor buskros. Rosa lite strimmiga halvfyllda blommor med lätt citrusdoft. Frisk ros med lång kontinuerlig blomning.',
  "CARL NIELSEN" => 'Blommar med stora gula, vackert formade blommor. Fin som snittros. Doften är ljuvlig och stark',
  "CHIPPENDALE" => 'Rosen Chippendale har en speciell blanding av rosa och orangea blommor som ger ett häftigt intryck. Blommorna är stora, tätt fylda och har en stark och behaglig doft av persika och mango. Blommar långt ut på hösten.',
  "DROTTNINGHOLM" => 'En rosa fin ros som är frisk och kraftig. Fin doft. Slottsros',
  "FELLOWSHIP" => 'Rabattros med ganska kraftigt och tätt växtsätt. Mörkgrönt bladverk. Medelstark doft.',
  "GELBE DAGMAR HASTRUP" => 'Blommar med stora, enkla blommor i en fin, gul rosa nyans. Talrika nypon på hösten pryder denna ros och ger en attraktiv effekt i trädgården. Angenäm söt doft av stenfrukter. Uppkallad efter rosförädlarens hustru.',
  "HANSESTADT ROSTOCK" => 'Stora, fyllda, aprikosa blommor i klasar. Doft av honung och citron. Bladverket är glänsande grönt. Fin både i rabatt och kruka.',
  "INGRID BERGMAN" => 'Ingrid Bergman är en praktfull och odlingsvärd ros med stora, mörkröda blommor och spriralvända kronblad. Utnämd till årets ros år 2000 av världsförbundet.',
  "LADY OF SHALOTT" => 'Denna austinros är mycket robust och härdig. Den har också mycket bra motståndskraft mot sjukdomar och remonterar ovanligt mycket under hela säsongen. Knopparna har en mörkt orange-röd ton.',
  "MUNSTEAD WOOD" => 'En ny mörkt purpurröd sort från David Austin som är vår favorit i denna färgskala. Knopparna har en ljusare nyans, men när rosen slår ut blir den djupt purpurfärgad i mitten medan de yttre kronbladen behåller den ljusare nyansen.',
  "PEACE" => 'En ros som är omtyckt och lättt att känna igen. Mycket stora blommor, upp till 16cm, först klotformade sedan skålformade. Först gul, sedan bleknar basen till crèmevitt medan de yttre kronbladen utvecklar en svagt rosa ton. ',
  "SCENTED GARDEN" => 'Scented Garden är en ros framtagen av Chris Warner, Storbritannien. Blommar länge med halvfyllda stora blommor som har rosa kanter, ljusgul mitt och citrongula vackert exponerade ståndare. Bladverket är blankt och mörkgrönt.',
  "SCHNEEWALTZER" => 'Stora vita blommor i klassisk rosform. Knopparna är ljust citrongula och blomman bleknar sedan till vit. Stora glansiga mörkgröna blad.',
